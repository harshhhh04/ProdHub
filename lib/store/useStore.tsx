...
const INITIAL_BIG_THREE: DailyBigThree = {
  ...
  task1: 'Debug Mutex Lock in Core Firmware Module',
  task2: 'Complete High Priority Engineering Task',
  task3: 'Review 10 Technical Interview Flashcards',
  completed1: true,
  completed2: false,
  completed3: false,
};
...
const INITIAL_PROJECTS: Project[] = [
  {
    id: 'proj-1',
    title: 'Professional Work Module',
    slug: 'professional-work',
    overview: 'High-throughput sensor payload parsing and driver optimization module.',
    status: 'active',
    category: 'internship',
    goals: ['Achieve low processing latency', 'Ensure zero memory leaks across 24h continuous soak test'],
    milestones: [
      { id: 'm1', title: 'Ring buffer architecture design', completed: true, targetDate: '2026-08-10' },
      { id: 'm2', title: 'Interrupt service routine optimization', completed: true, targetDate: '2026-08-15' },
      { id: 'm3', title: 'Integration with telemetry stack', completed: false, targetDate: '2026-08-25' },
    ],
    resources: [
      { id: 'r1', title: 'DMA Hardware Application Note', url: 'https://example.com' },
      { id: 'r2', title: 'Interrupt Controller Specification', url: 'https://example.com' }
    ],
    notes: 'Ensure proper flag clearing sequence in interrupt handlers.',
    progress: 75
  },
  {
    id: 'proj-2',
    ...
    slug: 'core-systems',
    overview: 'Custom preemptive kernel scheduler and synchronization primitives.',
    status: 'active',
    category: 'core',
    goals: ['Implement priority scheduler', 'Add Priority Inheritance Mutexes to resolve inversion'],
    milestones: [
      { id: 'm10', title: 'Context switching assembly routine', completed: true },
      { id: 'm11', title: 'Task Control Block & Stack Initialization', completed: true },
      { id: 'm12', title: 'Priority Inheritance Mutex Implementation', completed: false, targetDate: '2026-08-28' },
      { id: 'm13', title: 'Low-power idle mode implementation', completed: false, targetDate: '2026-09-05' },
    ],
    resources: [
      { id: 'r10', title: 'Kernel Architecture Reference', url: 'https://example.com' },
    ],
    notes: 'Process stack pointer used for tasks, main stack pointer used for ISR kernel handlers.',
    progress: 80
  },
  {
    id: 'proj-3',
    ...
    overview: 'Lightweight diagnostic logging framework for resource-constrained embedded microcontrollers.',
    status: 'active',
    category: 'core',
    ...
    milestones: [
      ...
      { id: 'm21', title: 'Circular storage buffer wear-leveling', completed: false },
      { id: 'm22', title: 'Host decoder CLI utility', completed: false },
    ],
    resources: [],
    notes: 'Lock-free ring buffer designed for ISR thread safety.',
    progress: 45
  },
  {
    id: 'proj-4',
    ...
    overview: 'System Architecture fundamentals, virtual memory mechanics, and IPC protocols.',
    status: 'active',
    category: 'core',
    goals: ['Master Paging, Virtual Memory, Cache Coherency, and System IPC'],
    milestones: [
      { id: 'm30', title: 'CPU Paging & TLB Mechanics', completed: true },
      { id: 'm31', title: 'System IPC: Shared Memory, Semaphores, Pipes', completed: false },
    ],
    resources: [],
    notes: 'Focus on cache line alignment and memory barriers.',
    progress: 55
  },
  {
    id: 'proj-5',
    ...
    overview: 'Wireless communication gateway firmware.',
    status: 'paused',
    category: 'freelance',
    goals: ['Low-power custom advertising payload configuration'],
    milestones: [],
    resources: [],
    notes: 'Development paused during primary technical review window.',
    progress: 25
  }
];
...
const INITIAL_MISSIONS: Mission[] = [
  {
    id: 'msn-1',
    title: 'Complete High Priority Engineering Task',
    description: 'Implement priority mutex synchronization and verify context switch safety.',
    priority: 'P0',
    ...
    definitionOfDone: [
      ...
      { id: 'dod-2', text: 'Add Priority Boosting algorithm', completed: true },
      { id: 'dod-3', text: 'Pass integration test suite', completed: false }
    ],
    notes: 'Follow standard architecture calling conventions.',
    projectId: 'proj-2',
    createdAt: new Date().toISOString()
  },
  {
    id: 'msn-2',
    title: 'Review Communication Protocol Concepts',
    description: 'Deep dive into communication protocol stacks, GATT profiles, MTU exchange, and paired connection flows.',
    priority: 'P1',
    ...
    actualHours: 2,
    definitionOfDone: [
      { id: 'dod-4', text: 'Summarize packet protocol structures', completed: true },
      { id: 'dod-5', text: 'Review attribute tables & descriptor sets', completed: false }
    ],
    projectId: 'proj-5',
    createdAt: new Date().toISOString()
  },
  {
    id: 'msn-3',
    title: 'Personal Project Storage Driver',
    description: 'Write low-level flash write routine with double-buffering.',
    priority: 'P0',
    category: 'Firmware',
    status: 'in_progress',
    deadline: '2026-08-20',
    ...
    actualHours: 3.5,
    definitionOfDone: [
      { id: 'dod-6', text: 'Implement DMA transfer complete callbacks', completed: true },
      { id: 'dod-7', text: 'Test ring buffer wear-leveling algorithm', completed: false }
    ],
    projectId: 'proj-3',
    createdAt: new Date().toISOString()
  },
  {
    id: 'msn-4',
    title: 'Complete Professional Work Module',
    description: 'Finalize Zero-copy binary parser for telemetry packets.',
    priority: 'P0',
    ...
    actualHours: 7,
    definitionOfDone: [
      { id: 'dod-8', text: 'Write unit tests for CRC hardware calculation', completed: true },
  ...
  {
    id: 'msn-5',
    title: 'Read 60 pages of Technical Book',
  ...
  },
  {
    ...
    description: 'Physical strength and conditioning routine.',
    priority: 'P2',
    category: 'Health',
    status: 'in_progress',
    deadline: '2026-08-16',
  ...
  },
  {
    ...
    description: 'Daily focus meditation sessions.',
    priority: 'P3',
    category: 'Health',
    status: 'in_progress',
    deadline: '2026-08-16',
...
const INITIAL_NOTES: KnowledgeNote[] = [
  {
    id: 'note-1',
    title: 'Mutex vs Binary Semaphore & Priority Inversion Solution',
    category: 'RTOS',
    content: `# Mutex vs Binary Semaphore & Priority Inversion

## 1. Core Difference
- **Binary Semaphore**: A signaling mechanism. Task A can signal Task B. Has **NO ownership**. Can be unlocked by any thread/ISR.
...
## 3. Key Takeaways for Technical Reviews
...
`,
    tags: ['RTOS', 'Concurrency', 'Embedded C', 'Technical Review'],
    backlinks: ['Core Systems Engineering'],
    updatedAt: new Date().toISOString()
  },
  {
    id: 'note-2',
    title: 'Communication Protocol Stack Architecture & Advertising',
    category: 'Communication Protocols',
    content: `# Communication Protocol Stack Architecture

## 1. Protocol Layers
1. **Physical Layer (PHY)**: Frequency spectrum, channels, modulation.
2. **Link Layer (LL)**: Controls Advertising, Scanning, Initiating, Connection states.
3. **Transport Layer**: Multiplexing data, fragmentation, and reassembly.
4. **Attribute Protocol (ATT)**: Key-value attribute database.
5. **Application Profile Layer**: Defines Services, Characteristics, and Descriptors.

## 2. Code Example: Characteristic Definition
\`\`\`c
typedef struct {
    uint16_t handle;
    uint16_t uuid;
...
\`\`\`
`,
    tags: ['Communication Protocols', 'Wireless', 'Firmware'],
    backlinks: ['Review Communication Protocol Concepts'],
    updatedAt: new Date().toISOString()
  },
  {
    id: 'note-3',
...
1. **Memory-Mapped Peripheral Registers** (e.g., \`#define UART_DR (*(volatile uint32_t*)0x40013804)\`).
2. **Global variables modified by an Interrupt Service Routine (ISR)**.
3. **Global variables shared between threads in a multi-threaded OS**.
...
const INITIAL_BOOKS: Book[] = [
  {
    id: 'book-1',
    title: 'Technical Engineering Book',
    author: 'Engineering Specialist',
    progressPercent: 85,
    totalPages: 320,
    readPages: 272,
    status: 'reading',
    keyIdeas: [
      'Architect system components with clean finite state machines (FSMs).',
      'Always design watchdog timers with non-maskable heartbeats.'
    ],
    quotes: [
      '"Engineering excellence is about clarity, precision, and reliable execution."'
    ],
    actionableLessons: [
      'Refactor driver routines into an explicit state machine queue.'
    ],
  ...
  },
  {
    ...
    status: 'reading',
    keyIdeas: [
      'Log-structured write mechanisms optimize sequential storage operations over random writes.'
    ],
    quotes: [
      '"System reliability is continuing to operate correctly even when components fail."'
    ],
    actionableLessons: [
      'Use append-only log format for non-volatile diagnostic storage.'
    ],
...
const INITIAL_HEALTH: HealthLog = {
  ...
  date: new Date().toISOString().split('T')[0],
  workoutDone: true,
  workoutNotes: 'Upper Body Strength & Mobility: Bench Press 85kg 4x6, Weighted Pull-ups, Overhead Press',
...
const INITIAL_INTERVIEW_QUESTIONS: InterviewQuestion[] = [
  ...
  {
    id: 'iq-2',
    question: 'What is the purpose of the `volatile` keyword in Embedded C? Give three hardware scenarios.',
  ...
  },
  {
    ...
    category: 'Protocols',
    company: 'Global Microelectronics',
    confidenceLevel: 4,
    lastReviewed: new Date().toISOString()
  },
  {
    ...
    company: 'Systems Architect Group',
    confidenceLevel: 4,
    lastReviewed: new Date().toISOString()
  },
  {
    id: 'iq-5',
    question: 'What is the difference between a spinlock and a mutex in a real-time context?',
...
const INITIAL_APPLICATIONS: PlacementApplication[] = [
  {
    id: 'app-1',
    company: 'Hardware Systems Inc.',
    role: 'Embedded Software Engineer',
    status: 'Interview',
    interviewDate: '2026-08-28',
    notes: 'Upcoming Technical Interview round focused on kernel internals, C memory management, and driver development.',
    salaryLocation: 'Tech Hub | Competitive Package',
  ...
  },
  {
    ...
    status: 'OA',
    oaDate: '2026-08-20',
    notes: 'Online Assessment: Data structures, bitwise manipulation, DMA, and C primitives.',
    salaryLocation: 'Innovation Park | Competitive Package',
    link: 'https://example.com/careers'
  },
  {
    id: 'app-3',
    company: 'Microcontroller Tech',
    role: 'Firmware Developer',
    status: 'Applied',
    deadline: '2026-09-02',
    notes: 'Applied via online portal for peripheral library team.',
    salaryLocation: 'Engineering Center',
    link: 'https://example.com/careers'
  },
  {
    id: 'app-4',
    company: 'Systems Architecture Corp',
    role: 'Systems Engineer',
    status: 'Applied',
    deadline: '2026-09-10',
    notes: 'Core software architecture team application.',
    salaryLocation: 'Tech Center',
    link: 'https://example.com/careers'
  },
  {
    id: 'app-5',
    ...
    status: 'Offer',
    notes: 'Offer letter extended! Response timeline active.',
    salaryLocation: 'Metropolitan Tech Center',
    link: 'https://example.com/careers'
  }
];
...
const INITIAL_DEEP_WORK: DeepWorkSession[] = [
  {
    id: 'dw-1',
    missionTitle: 'Complete High Priority Engineering Task',
    durationMinutes: 90,
    accomplishments: 'Implemented Priority Inheritance logic in scheduler and verified context switch.',
    interruptions: 0,
    timestamp: new Date(Date.now() - 3600000 * 4).toISOString()
  },
  {
    id: 'dw-2',
    missionTitle: 'Complete Professional Work Module',
    durationMinutes: 60,
    accomplishments: 'Wrote unit tests for CRC hardware calculation and verified bounds checking.',
    interruptions: 1,
